...
**Status:** COMPLETED / SUPERSEDED — every phase below was delivered in the Feb-2026 refactor and merged. Path vocabulary (`utils/`, `model/`, `utils/loss/`) is historical and does not match the 0.2.x tree (`infrastructure/`, `catalogs/`, `math/`, `dataset/`). Kept as a record of the plan. Not a live roadmap.  
