...
def main(
    ...
    val_series_log1p: list[
        TimeSeries
    ],  # New: expects list of TimeSeries for log1p data
    nbeats_hps: dict,
    model_configs: dict,
    trainer_config: dict,
    ...
    predictions_log1p_list = model.predict(
        n=n_predict, series=val_series_log1p
    )  # Pass list of series
...
if __name__ == "__main__":
    ...
    full_series_raw = TimeSeries.from_dataframe(
        raw_df,
        "time",
        "target",
        group_cols="country_id",
