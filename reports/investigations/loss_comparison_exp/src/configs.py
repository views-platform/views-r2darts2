...
DATA_CONFIG = {
    ...
    "LOGNORMAL_MEAN_NORMAL_PARAMS": {"loc": 0.5, "scale": 0.3}, # Mean of log-magnitudes
    "LOGNORMAL_SIGMA_LOGNORMAL_PARAMS": {"mean": 0.0, "sigma": 0.5}, # Variability of log-magnitudes
}
