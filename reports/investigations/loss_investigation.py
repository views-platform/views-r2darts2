...
def analyze_loss_functions():
    ...
    fig.suptitle('Loss and Gradient Landscape Analysis Across Transformations', fontsize=16)
    ...
    for i, (trans_name, (targets, preds_range)) in enumerate(transformations.items()):
        ...
        shrinkage_loss_fn = ShrinkageLoss(a=5.0, c=0.5) # Adjusted params for broader view
        shrinkage_losses = []
    ...
    print("Analysis complete. Plot saved to loss_landscape_analysis_with_transforms.png")
