...
def plot_quantile_loss_landscape():
    ...
    ax_loss.grid(True)
    ax_loss.axvline(x=0, color='black', linestyle='--', label='Perfect Prediction (Error = 0)')
    ...
    for tau in tau_values:
        loss_fn = AsymmetricQuantileLoss(tau=tau, non_zero_weight=1.0) # Disable weighting for clarity
        losses = []
        grads = []
