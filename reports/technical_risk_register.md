...
- **Cross-refs:** Related to C-02 (same file, same evaluation path, same absence of regression coverage).
...
- **Cross-refs:** Related to C-01 (both concern the evaluation path and both lack unit tests).
