# file: sweep_configs/asymmetric_quantile_a_sweep.py

def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the AsymmetricQuantileLoss for Pipeline A: log1p + minmax(0,1).
    """

    sweep_config = {
        'method': 'grid',
        'name': 'asymmetric_quantile_A_pipeline_test',
        'metric': {
