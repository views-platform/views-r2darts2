# file: sweep_configs/asymmetric_quantile_b_sweep.py


def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the AsymmetricQuantileLoss for Pipeline B: raw_counts.
    """

    sweep_config = {
        "method": "grid",
        "name": "asymmetric_quantile_B_pipeline_test",
