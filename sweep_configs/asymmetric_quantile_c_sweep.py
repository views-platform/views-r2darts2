# file: sweep_configs/asymmetric_quantile_c_sweep.py

def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the AsymmetricQuantileLoss for Pipeline C: asinh + standard.
    """

    sweep_config = {
        'method': 'grid',
        'name': 'asymmetric_quantile_C_pipeline_test',
        'metric': {
