# file: sweep_configs/shrinkage_b_sweep.py


def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the ShrinkageLoss for Pipeline B: raw_counts.
    """

    sweep_config = {
        "method": "grid",
        "name": "shrinkage_B_pipeline_test",
    ...
    parameters = {
        ...
        "c": {"values": [50.0, 150.0, 300.0]},  # larger range for raw counts
        # --- Trainer & Optimizer ---
        "n_epochs": {"values": [300]},
        "lr": {"values": [0.0006]},
