# file: sweep_configs/timeaware_weighted_huber_c_sweep.py


def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the TimeAwareWeightedHuberLoss for Pipeline C: asinh + standard.
    """

    sweep_config = {
        "method": "grid",
        "name": "time_aware_weighted_huber_C_pipeline_test",
    ...
    parameters = {
        ...
        "batch_size": {"values": [8]},
        "target_scaler": {"values": ["StandardScaler"]},
