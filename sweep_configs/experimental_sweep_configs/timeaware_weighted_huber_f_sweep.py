# file: sweep_configs/timeaware_weighted_huber_f_sweep.py


def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the TimeAwareWeightedHuberLoss for Pipeline F: pure_asinh.
    """

    sweep_config = {
        "method": "grid",
        "name": "time_aware_weighted_huber_F_pipeline_test",
