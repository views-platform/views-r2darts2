# file: sweep_configs/weighted_penalty_huber_e_sweep.py


def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the WeightedPenaltyHuberLoss for Pipeline E: pure_log1p.
    """

    sweep_config = {
        "method": "grid",
        "name": "weighted_penalty_huber_E_pipeline_test",
