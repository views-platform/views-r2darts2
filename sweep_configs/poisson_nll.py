# file: sweep_configs/poisson_nll.py

def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the PoissonNLLLoss.
    """

    sweep_config = {
        'method': 'grid',
        'name': 'poisson_nll_test',
        'metric': {
    ...
    parameters = {
        ...
        # --- Loss Function ---
        'loss_function': {'values': ['PoissonNLLLoss']},
        'log_input': {'values': [True, False]}, # PoissonNLLLoss specific parameter
