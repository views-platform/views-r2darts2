# file: sweep_configs/spikefocal_a_sweep.py

def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the SpikeFocalLoss for Pipeline A: log1p + minmax(0,1).
    """

    sweep_config = {
        'method': 'grid',
        'name': 'spike_focal_A_pipeline_test',
        'metric': {
    ...
    parameters = {
        ...
        'spike_threshold': {'values': [0.75, 0.9, 0.95]},
