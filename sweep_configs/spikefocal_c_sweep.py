# file: sweep_configs/spikefocal_c_sweep.py

def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the SpikeFocalLoss for Pipeline C: asinh + standard.
    """

    sweep_config = {
        'method': 'grid',
        'name': 'spike_focal_C_pipeline_test',
        'metric': {
    ...
    parameters = {
        ...
        'spike_threshold': {'values': [1.5, 2.0, 2.5]}, # high quantiles for standardized data
