...
SWEEP_CONFIG = {
    ...
    'loss_fn_class': {'values': ['WeightedPenaltyHuberLoss', 'AsymmetricQuantileLoss', 'SpikeFocalLoss']},
    ...
    'steps': {'values': [[*range(1, 37)]]}, # Example for 'steps' parameter often used in evaluation
}
