# file: sweep_configs/weighted_penalty_huber_b_sweep.py


def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the WeightedPenaltyHuberLoss for Pipeline B: raw_counts.
    """

    sweep_config = {
        "method": "grid",
        "name": "weighted_penalty_huber_B_pipeline_test",
    ...
    parameters = {
        ...
        "zero_threshold": {"values": [0.1, 0.5, 1.0]},  # Small counts for threshold
