# file: sweep_configs/weighted_penalty_huber_c_sweep.py

def get_sweep_config():
    """
    Contains the configuration for hyperparameter sweeps using WandB.
    This sweep tests the WeightedPenaltyHuberLoss for Pipeline C: asinh + standard.
    """

    sweep_config = {
        'method': 'grid',
        'name': 'weighted_penalty_huber_C_pipeline_test',
        'metric': {
    ...
    parameters = {
        ...
        'zero_threshold': {'values': [0.001]}, # for standardized data, near zero is the threshold
        'delta': {'values': [0.5, 1.5]},
        ...
        'batch_size': {'values': [8]},
        'target_scaler': {'values': ['StandardScaler']}, # StandardScaler for this pipeline
