...
class TestParameterPassing(unittest.TestCase):
    def test_loss_selector_passes_tau(self):
        ...
        loss_instance_1 = LossSelector.get_loss_function(
            config_1["loss_function"], **config_1
        )
        ...
        self.assertIsInstance(
            ...
            "Failed to create correct loss class.",
        )
        self.assertEqual(
            loss_instance_1.tau,
            0.95,
            "Failed to pass tau=0.95. The parameter was ignored.",
        )
        ...
        loss_instance_2 = LossSelector.get_loss_function(
            config_2["loss_function"], **config_2
        )
        ...
        self.assertEqual(
            loss_instance_2.tau,
            0.50,
            "Failed to pass tau=0.50. The parameter was ignored.",
        )
        ...
        loss_instance_3 = LossSelector.get_loss_function(
            config_3["loss_function"], **config_3
        )
        ...
        self.assertEqual(
            loss_instance_3.tau,
            0.75,
            "Loss function did not fall back to the default tau=0.75.",
        )
        print(
            f"SUCCESS: Loss function correctly fell back to default tau = {loss_instance_3.tau}"
        )
