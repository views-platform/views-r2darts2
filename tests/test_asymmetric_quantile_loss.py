...
def test_asymmetric_quantile_loss_golden_values(pred_val, target_val, tau, non_zero_weight, expected_loss):
    """Tests the forward pass of AsymmetricQuantileLoss against manually calculated golden values."""
    loss_fn = AsymmetricQuantileLoss(tau=tau, non_zero_weight=non_zero_weight, zero_threshold=0.1)
