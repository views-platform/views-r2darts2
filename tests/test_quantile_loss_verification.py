...
class TestQuantileLossVerification(unittest.TestCase):
    def test_golden_values(self):
        ...
        loss_fn_75 = AsymmetricQuantileLoss(
            tau=0.75, non_zero_weight=1.0, zero_threshold=0.01
        )  # Disable weighting
        ...
        loss_fn_50 = AsymmetricQuantileLoss(
        ...
        loss_fn_weighted = AsymmetricQuantileLoss(
            tau=0.8, non_zero_weight=10.0, zero_threshold=0.5
        )
    ...
    def test_gradient_correctness(self):
        ...
        loss_fn = AsymmetricQuantileLoss(
            tau=0.8, non_zero_weight=10.0, zero_threshold=0.01
        ).double()
