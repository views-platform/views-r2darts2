...
@pytest.mark.parametrize(
    ...
    [
        ...
        (torch.tensor([2.0]), torch.tensor([0.5]), 1.0, 1.0, 10.0, 1.0), # target < threshold
        ...
        (torch.tensor([2.0]), torch.tensor([0.5]), 0.01, 1.0, 10.0, 10.0), # target > threshold
...
def test_weighted_huber_loss_golden_values(preds, targets, zero_threshold, delta, non_zero_weight, expected_loss):
