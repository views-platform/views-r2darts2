...
if __name__ == "__main__":
    ...
    if params_total64 == params_total128:
        ...
        print(
            "This confirms the `layer_widths` parameter is not being used correctly during model creation."
        )
        ...
        print(
            "This suggests the problem may lie in your training/evaluation script, not the model architecture itself."
        )
